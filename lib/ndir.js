...
exports.mkdirAsync = eval(Jscex.compile("async", function (dir) {
  var parent = path.dirname(dir);
  var exists = $await(fs.existsAsync(parent));
  if (!exists) {
    $await(exports.mkdirAsync(parent));
  }
  exists = $await(fs.existsAsync(dir));
  if (!exists) {
